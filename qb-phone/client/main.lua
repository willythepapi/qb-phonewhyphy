...
RegisterNetEvent('qb-phone:client:ReceivePhone', function(serialNumber)
    local src = source
    QBCore.Functions.TriggerCallback('qb-phone:server:GetPhoneData', function(phoneData)
        -- Telefon verilerini yükle ve istemciye gönder
        SendNUIMessage({
